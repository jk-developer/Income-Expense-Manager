...
public class IncomeItemActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatePickerDialog datePickerDialog = new DatePickerDialog(this, IncomeItemActivity.this, incyear, incmonth, incday);

        Calendar cTime = Calendar.getInstance();
        int inchour = cTime.get( Calendar.HOUR_OF_DAY );
        int incminute = cTime.get( Calendar.MINUTE );
        final TimePickerDialog timePickerDialog = new TimePickerDialog( this,IncomeItemActivity.this, inchour, incminute, android.text.format.DateFormat.is24HourFormat(this) );
       ...
       // etValue.setSelection(String.valueOf( amt ).toString().length());
        ...
        tvDelete.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder item_builder = new AlertDialog.Builder(IncomeItemActivity.this);
                ...
                item_builder.setPositiveButton( "DELETE RECORD", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        incomedbRef = FirebaseDatabase.getInstance().getReference("income").child( id);
                        incomedbRef.removeValue();

                        Intent i = new Intent( IncomeItemActivity.this, MainActivity.class );
                        startActivity( i );
        ...
        tvSave.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder save_builder = new AlertDialog.Builder(IncomeItemActivity.this);
                ...
                save_builder.setPositiveButton( "Save", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                       ...
                       String newIncomeType = tvCategory.getText().toString().trim();

                        IncomeData incomeData = new IncomeData( incomeId, newIncomeType, newAmount, newDate, newTime, newDesc );
                        incomedbRef = FirebaseDatabase.getInstance().getReference("income").child( id);
                        incomedbRef.setValue( incomeData );
        ...
        tvHintCategory.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder income_builder = new AlertDialog.Builder(IncomeItemActivity.this);
               ...
               income_builder.setItems( incomeItems, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText( IncomeItemActivity.this, ""+incomeItems[which], Toast.LENGTH_SHORT ).show();
                    }
                } );
